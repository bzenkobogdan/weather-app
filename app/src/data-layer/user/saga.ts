...
const apiSearchByCoords = async ({ value }: { value: string }) => await http.get(`https://cors-anywhere.herokuapp.com/https://www.metaweather.com/api/location/search/?lattlong=${value}`);
